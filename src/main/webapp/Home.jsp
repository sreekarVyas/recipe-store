...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	        ...
	        <ul class="navbar-nav ml-auto">
	            ...
	            <li class="nav-item">
	                <a class="nav-link" href="AboutUs.jsp">Meet The Creators</a>
	            </li>	            
	        </ul>
	    </div>
	</nav>
    ...
    <div class="container">
		...
		<%
			List<Recipe> recipes= GetRecipes.getRecipes();
			...
			<div class="col mb-5">
				<div class="card">
		      		<div class="card-body">
		        		...
		        		<p class="card-text"><small class="text-body-secondary"><%= rp.roname %></small></p>
